...
#line 1 "tests/test_evil.toml.test.tc"
...
int main(int argc, char **argv) {
    ...
    extern void test_case1(intmax_t INVALSET, intmax_t TAIL_TYPE);
    if (argc < 3 || (case_ == 1 && perm == 1)) { test_case1(3, LFS_TYPE_HARDTAIL); }
    extern void test_case1(intmax_t INVALSET, intmax_t TAIL_TYPE);
    if (argc < 3 || (case_ == 1 && perm == 2)) { test_case1(3, LFS_TYPE_SOFTTAIL); }
    extern void test_case1(intmax_t INVALSET, intmax_t TAIL_TYPE);
    if (argc < 3 || (case_ == 1 && perm == 3)) { test_case1(1, LFS_TYPE_HARDTAIL); }
    extern void test_case1(intmax_t INVALSET, intmax_t TAIL_TYPE);
    if (argc < 3 || (case_ == 1 && perm == 4)) { test_case1(1, LFS_TYPE_SOFTTAIL); }
    extern void test_case1(intmax_t INVALSET, intmax_t TAIL_TYPE);
    if (argc < 3 || (case_ == 1 && perm == 5)) { test_case1(2, LFS_TYPE_HARDTAIL); }
    extern void test_case1(intmax_t INVALSET, intmax_t TAIL_TYPE);
    if (argc < 3 || (case_ == 1 && perm == 6)) { test_case1(2, LFS_TYPE_SOFTTAIL); }
    extern void test_case2(intmax_t INVALSET);
    if (argc < 3 || (case_ == 2 && perm == 1)) { test_case2(3); }
    extern void test_case2(intmax_t INVALSET);
    if (argc < 3 || (case_ == 2 && perm == 2)) { test_case2(1); }
    extern void test_case2(intmax_t INVALSET);
    if (argc < 3 || (case_ == 2 && perm == 3)) { test_case2(2); }
    extern void test_case3(intmax_t SIZE);
    if (argc < 3 || (case_ == 3 && perm == 1)) { test_case3(10); }
    extern void test_case3(intmax_t SIZE);
    if (argc < 3 || (case_ == 3 && perm == 2)) { test_case3(1000); }
    extern void test_case3(intmax_t SIZE);
    if (argc < 3 || (case_ == 3 && perm == 3)) { test_case3(100000); }
    extern void test_case4(intmax_t SIZE);
    if (argc < 3 || (case_ == 4 && perm == 1)) { test_case4(2*LFS_BLOCK_SIZE); }
    extern void test_case4(intmax_t SIZE);
    if (argc < 3 || (case_ == 4 && perm == 2)) { test_case4(3*LFS_BLOCK_SIZE); }
    extern void test_case4(intmax_t SIZE);
    if (argc < 3 || (case_ == 4 && perm == 3)) { test_case4(4*LFS_BLOCK_SIZE); }
    extern void test_case5(intmax_t INVALSET);
    if (argc < 3 || (case_ == 5 && perm == 1)) { test_case5(3); }
    extern void test_case5(intmax_t INVALSET);
    if (argc < 3 || (case_ == 5 && perm == 2)) { test_case5(1); }
    extern void test_case5(intmax_t INVALSET);
    if (argc < 3 || (case_ == 5 && perm == 3)) { test_case5(2); }

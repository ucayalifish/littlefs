...
#line 1 "tests/test_orphans.toml.test.tc"
...
void test_case2(
    ...
    // test case 2
    #line 69 "tests/test_orphans.toml"
...
int main(int argc, char **argv) {
    ...
    extern void test_case2(intmax_t DEPTH, intmax_t FILES);
    if (argc < 3 || (case_ == 2 && perm == 1)) { test_case2(1, 6); }
    extern void test_case2(intmax_t DEPTH, intmax_t FILES);
    if (argc < 3 || (case_ == 2 && perm == 2)) { test_case2(1, 26); }
    extern void test_case2(intmax_t DEPTH, intmax_t FILES);
    if (argc < 3 || (case_ == 2 && perm == 3)) { test_case2(3, 3); }
}

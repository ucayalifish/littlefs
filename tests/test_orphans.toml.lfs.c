...
#line 1 "tests/test_orphans.toml.lfs.tc"
#line 1 "lfs.c"
/*
...
void test_case1() {
    ...
    // test case 1
    #line 5 "tests/test_orphans.toml"
    ...
    __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_mkdir(&lfs, "parent/orphan"), 0);
    __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_mkdir(&lfs, "parent/child"), 0);
    __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_remove(&lfs, "parent/orphan"), 0);
    ...
    __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_mount(&lfs, &cfg), 0);
    __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_stat(&lfs, "parent/orphan", &info), LFS_ERR_NOENT);
    __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_stat(&lfs, "parent/child", &info), 0);
    __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_fs_size(&lfs), 8);
    __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_unmount(&lfs), 0);
    ...
    // should be unchanged
    __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_mkdir(&lfs, "parent/otherchild"), 0);
    __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_stat(&lfs, "parent/orphan", &info), LFS_ERR_NOENT);
    __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_stat(&lfs, "parent/child", &info), 0);
    __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_stat(&lfs, "parent/otherchild", &info), 0);
    __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_fs_size(&lfs), 8);
    __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_unmount(&lfs), 0);

...
#line 1 "tests/test_superblocks.toml.test.tc"
...
void test_case1() {
    ...
    // test case 1
    #line 3 "tests/test_superblocks.toml"
...
void test_case2() {
    ...
    // test case 2
    #line 8 "tests/test_superblocks.toml"
    __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_format(&lfs, &cfg), 0);
...
void test_case3() {
    ...
    // test case 3
    #line 16 "tests/test_superblocks.toml"
...
void test_case4() {
    ...
    // test case 4
    #line 26 "tests/test_superblocks.toml"
...
void test_case5(
    ...
    // test case 5
    #line 33 "tests/test_superblocks.toml"
    __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_format(&lfs, &cfg), 0);
    __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_mount(&lfs, &cfg), 0);
    for (int i = 0; i < N; i++) {
        __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_file_open(&lfs, &file, "dummy",
                LFS_O_WRONLY | LFS_O_CREAT | LFS_O_EXCL), 0);
        __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_file_close(&lfs, &file), 0);
        __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_stat(&lfs, "dummy", &info), 0);
        __LFS_ASSERT_STR_EQ(__FILE__, __LINE__, info.name, "dummy");
        __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, info.type, LFS_TYPE_REG);
        __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_remove(&lfs, "dummy"), 0);
    }
    __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_unmount(&lfs), 0);
...
void test_case6(
    ...
    // test case 6
    #line 61 "tests/test_superblocks.toml"
    __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_format(&lfs, &cfg), 0);
    for (int i = 0; i < N; i++) {
        __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_mount(&lfs, &cfg), 0);
        // remove lingering dummy?
        err = lfs_stat(&lfs, "dummy", &info);
        __LFS_ASSERT_BOOL_EQ(__FILE__, __LINE__, err == 0 || (err == LFS_ERR_NOENT && i == 0), true);
        if (!err) {
            __LFS_ASSERT_STR_EQ(__FILE__, __LINE__, info.name, "dummy");
            __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, info.type, LFS_TYPE_REG);
            __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_remove(&lfs, "dummy"), 0);
...
void test_case7(
    ...
    // test case 7
    #line 95 "tests/test_superblocks.toml"
    err = lfs_mount(&lfs, &cfg);
    if (err) {
        __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_format(&lfs, &cfg), 0);
        __LFS_ASSERT_INT_EQ(__FILE__, __LINE__, lfs_mount(&lfs, &cfg), 0);
...
int main(int argc, char **argv) {
    ...
    extern void test_case5(intmax_t LFS_BLOCK_CYCLES, intmax_t N);
    if (argc < 3 || (case_ == 5 && perm == 1)) { test_case5(32, 10); }
    extern void test_case5(intmax_t LFS_BLOCK_CYCLES, intmax_t N);
    if (argc < 3 || (case_ == 5 && perm == 2)) { test_case5(32, 100); }
    extern void test_case5(intmax_t LFS_BLOCK_CYCLES, intmax_t N);
    if (argc < 3 || (case_ == 5 && perm == 3)) { test_case5(32, 1000); }
    extern void test_case5(intmax_t LFS_BLOCK_CYCLES, intmax_t N);
    if (argc < 3 || (case_ == 5 && perm == 4)) { test_case5(33, 10); }
    extern void test_case5(intmax_t LFS_BLOCK_CYCLES, intmax_t N);
    if (argc < 3 || (case_ == 5 && perm == 5)) { test_case5(33, 100); }
    extern void test_case5(intmax_t LFS_BLOCK_CYCLES, intmax_t N);
    if (argc < 3 || (case_ == 5 && perm == 6)) { test_case5(33, 1000); }
    extern void test_case5(intmax_t LFS_BLOCK_CYCLES, intmax_t N);
    if (argc < 3 || (case_ == 5 && perm == 7)) { test_case5(1, 10); }
    extern void test_case5(intmax_t LFS_BLOCK_CYCLES, intmax_t N);
    if (argc < 3 || (case_ == 5 && perm == 8)) { test_case5(1, 100); }
    extern void test_case5(intmax_t LFS_BLOCK_CYCLES, intmax_t N);
    if (argc < 3 || (case_ == 5 && perm == 9)) { test_case5(1, 1000); }
    extern void test_case6(intmax_t LFS_BLOCK_CYCLES, intmax_t N);
    if (argc < 3 || (case_ == 6 && perm == 1)) { test_case6(32, 10); }
    extern void test_case6(intmax_t LFS_BLOCK_CYCLES, intmax_t N);
    if (argc < 3 || (case_ == 6 && perm == 2)) { test_case6(32, 100); }
    extern void test_case6(intmax_t LFS_BLOCK_CYCLES, intmax_t N);
    if (argc < 3 || (case_ == 6 && perm == 3)) { test_case6(32, 1000); }
    extern void test_case6(intmax_t LFS_BLOCK_CYCLES, intmax_t N);
    if (argc < 3 || (case_ == 6 && perm == 4)) { test_case6(33, 10); }
    extern void test_case6(intmax_t LFS_BLOCK_CYCLES, intmax_t N);
    if (argc < 3 || (case_ == 6 && perm == 5)) { test_case6(33, 100); }
    extern void test_case6(intmax_t LFS_BLOCK_CYCLES, intmax_t N);
    if (argc < 3 || (case_ == 6 && perm == 6)) { test_case6(33, 1000); }
    extern void test_case6(intmax_t LFS_BLOCK_CYCLES, intmax_t N);
    if (argc < 3 || (case_ == 6 && perm == 7)) { test_case6(1, 10); }
    extern void test_case6(intmax_t LFS_BLOCK_CYCLES, intmax_t N);
    if (argc < 3 || (case_ == 6 && perm == 8)) { test_case6(1, 100); }
    extern void test_case6(intmax_t LFS_BLOCK_CYCLES, intmax_t N);
    if (argc < 3 || (case_ == 6 && perm == 9)) { test_case6(1, 1000); }
    extern void test_case7(intmax_t LFS_BLOCK_CYCLES);
    if (argc < 3 || (case_ == 7 && perm == 1)) { test_case7(2); }
    extern void test_case7(intmax_t LFS_BLOCK_CYCLES);
    if (argc < 3 || (case_ == 7 && perm == 2)) { test_case7(1); }
}
